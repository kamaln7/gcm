...
public class AddMapCommand implements Command {
    public static class Input extends gcm.commands.Input {
        ...
        public Input(String title, String description, String version, int one_off_price, int subscription_price) {
            this.title = title;
    ...
    public Output runOnServer(Request request, Server server, ConnectionToClient client) throws Exception {
        ...
        Map map = new Map(input.one_off_price,input.subscription_price,input.title,input.description,input.version);
        map.insert();
